...
describe("(Payment.test.js)", () => {
  ...
  describe("validatePayment", () => {
    ...
    it("validatePayment should return currency code errors", () => {
      ...
      expect(invalid.msg[0]).toEqual(
        "currency is not a valid ISO-4217 country code"
      );
    });
  });
  ...
  it("fetchCollection will return attach parameters", done => {
    ...
    payment
      .fetchCollection("payments/donations", { gwid })
      .then(r => {
        response = r;
      })
      .catch(I);
