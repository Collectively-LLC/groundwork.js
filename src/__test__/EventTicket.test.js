...
describe("(EventTicket.test.js)", () => {
  ...
  describe("validatePayload", () => {
    const payloads = [[TICKET, ticketSchema, "attendeeGwid"]];
  ...
  describe("listTickets", () => {
    ...
    it("returns an object containing an array of all category tickets", done => {
      ...
      const r = event
        .listTickets(EVENT_ID, CATEGORY_ID)
        .then(i => response = i)
        .catch(I);
  ...
  describe("fetchTicket", () => {
    ...
    it("returns a ticket on 200", done => {
      ...
      const r = event
        .listTickets(EVENT_ID, CATEGORY_ID, TICKET_ID)
        .then(i => response = i)
        .catch(I);
      expect(r).toEqual(jasmine.any(Promise));
  ...
  describe("createTicket", () => {
    ...
    it("returns a ticket on 200", done => {
      ...
      const r = event
        .createTicket(EVENT_ID, CATEGORY_ID, p)
        .then(i => response = i)
        .catch(I);
      expect(r).toEqual(jasmine.any(Promise));
  ...
  describe("updateTicket", () => {
    ...
    it("returns an updated ticket on 200", done => {
      ...
      const r = event
        .updateTicket(EVENT_ID, CATEGORY_ID, TICKET_ID, p)
        .then(i => response = i)
        .catch(I);
      expect(r).toEqual(jasmine.any(Promise));
  ...
  describe("replaceTicket", () => {
    ...
    it("returns a replaced ticket on 200", done => {
      ...
      const r = event
        .replaceTicket(EVENT_ID, CATEGORY_ID, TICKET_ID, p)
        .then(i => response = i)
        .catch(I);
      expect(r).toEqual(jasmine.any(Promise));
  ...
  describe("delTicket", () => {
    ...
    it("returns 204 on success", done => {
      ...
      const r = event
        .delTicket(EVENT_ID, CATEGORY_ID, TICKET_ID)
        .then(i => response = i)
        .catch(I);
      expect(r).toEqual(jasmine.any(Promise));
