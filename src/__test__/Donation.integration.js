...
import Groundwork from "../index";

const API_KEY =
  "pub-lantern.groundworkjs-launchpad--RQW_fyEo.1sxOAZxl1bX1aIweVg1IuBlC1_NqGkzkrUVnrIiRa7kM__XERxEAxSF6WzUVVhnleRmyrZsA.vvWg"; /* eslint max-len: 0 */
...
import donationSchema from "../.from ../src/schema/donation";
      ...
      gw.subscriptions
        ...
        .then(resp => {
          ...
          expect(subscription).toEqual(
            jasmine.objectContaining(SUBSCRIPTION_RESPONSE)
          );
          if (i === 4) done();
        })
